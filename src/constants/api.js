...
// export const PACKAGE_RECORD = '/treasure/group/package_record';//加入宝箱房间
// export const TODAY_GRABBED_RECORD = '/treasure/group/today_grabbed_record';//加入宝箱房间
// export const WECHAT_QRPAY = '/index/paymethod/wechat_qrpay';//加入宝箱房间
...
export const WECHAT_QRPAY = '/api/index/paymethod/wechat_qrpay';//加入宝箱房间  //加入宝箱房间
